...
import { xiaomiAccesory } from "../containerProduct/xiaomiAccesory";

export default function XiaomiAccesoryScrem() {
    const {addProducto}=useContext(dataContent);
    const back = useNavigate();
    const {nombre} = useParams();
    const product = xiaomiAccesory.find((x) => x.nombre === nombre);
    return (
      <>
