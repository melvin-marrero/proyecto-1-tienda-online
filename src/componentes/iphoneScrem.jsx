...
export default function IphoneScrem() {
  ...
  useEffect(() => {
    const fetchProductos = async () => {
        try {
            const response = await fetch('https://bask-end-tiend-online.onrender.com/api/iphone'); // Ajusta la URL según tu configuración
            if (!response.ok) {
            ...
            <div className="row g-0">
                ...
                <div className="col-md-6 col-sm-12">
                    <div className="card-body">
                      ...
                      <p className="precio">disponibles: {product.cantidaDisponible}</p>
                    </div>
