...
export default function IphonAcesoryAdmin(){
...
const handleEliminar = async (id) => {
    if (window.confirm("¿Estás seguro de que deseas eliminar este producto?")) {
      try {
        const response = await fetch(`https://bask-end-tiend-online.onrender.com/api/iphonAcesory/${id}`, {
          method: 'DELETE',
        });
...
<div className="conten">
    ...
    <div className="containe-produc-panel">
        <ModalFormulario product={"iphonAcesory"}/>
